...
//
//                .antMatchers(HttpMethod.POST, "/api/user/add-new-client").hasRole("Manager")
//                .antMatchers(HttpMethod.POST, "/api/user/add-new-trainer").hasRole("Manager")
//                .antMatchers(HttpMethod.POST, "/api/user/add-new-manager").hasRole("Admin")
//                .antMatchers(HttpMethod.POST, "/api/user/add-new-admin").hasRole("Admin")
//
//
//                .antMatchers(HttpMethod.GET,"/api/user/get-client-by-id/{id}").hasAnyRole("ADMIN", "Manager")
//                .antMatchers(HttpMethod.GET,"/api/user/get-trainer-by-id/{id}").hasAnyRole("Admin", "Manager")
//                .antMatchers(HttpMethod.GET,"/api/user/get-manager-by-id/{id}").hasRole("Admin")
//                .antMatchers(HttpMethod.GET,"/api/user/get-admin-by-id/{id}").hasRole("Admin")
//
...
//
//
//                .antMatchers(HttpMethod.POST, "/api/list-exercises/add-new-list-exercises").hasAnyRole("Trainer", "Client")
