...
public class ApplicationStartRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        roleAdmin.setRoleName(RolesEnum.ROLE_ADMIN);
        roleAdmin.setUser(admin);

        UserRole roleManger = new UserRole();
        roleManger.setRoleName(RolesEnum.ROLE_MANAGER);
        roleManger.setUser(manager);

        UserRole roleTrainer = new UserRole();
        roleTrainer.setRoleName(RolesEnum.ROLE_TRAINER);
        roleTrainer.setUser(trainer);

        UserRole roleUser = new UserRole();
        roleUser.setRoleName(RolesEnum.ROLE_CLIENT);
